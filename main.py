...
def _build_ai_system_prompt(db: Session) -> str:
    ...
    lines = [
        ...
        "- Combined Score: 0 = maximum fatigue, 10 = fully fresh/recovered",
        "- Subjective Score: 0 = maximum fatigue, 10 = fully fresh/recovered",
        "- Objective Score: 0 = maximum load/fatigue, 10 = fully recovered",
        "- Tiredness: 0 = no tiredness, 4 = exhausted",
        "- Perceived Recovery: 0 = not recovered at all, 4 = fully recovered",
        "- Soreness (per region): 0 = no soreness, 4 = severe soreness/injury",
        "- Joint Health: 0 = no pain, 4 = severe pain/injury",
        "- TSB: positive = more fitness than fatigue (favorable), negative = more fatigue than fitness (caution)",
